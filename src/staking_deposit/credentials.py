...
from src.staking_deposit.exceptions import ValidationError
from src.staking_deposit.key_handling.key_derivation.path import mnemonic_and_path_to_key
from src.staking_deposit.key_handling.keystore import (
    Keystore,
    ScryptKeystore,
)
from src.staking_deposit.settings import DEPOSIT_CLI_VERSION, BaseChainSetting
from src.staking_deposit.utils.constants import (
...
from src.staking_deposit.utils.crypto import SHA256
from src.staking_deposit.utils.intl import load_text
from src.staking_deposit.utils.ssz import (
...
class CredentialList:
    ...
    def from_mnemonic(cls,
        ...
        with click.progressbar(key_indices, label='msg_key_creation',
